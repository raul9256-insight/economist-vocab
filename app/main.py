...
TRANSLATIONS = {
    "en": {
        ...
        "start_recommended_practice": "Start Recommended Practice",
        "secondary_actions": "Other options",
        "learning_primary_review": "Review Mistakes First",
        "learning_primary_next": "Start Next 10 Words",
        "deep_learning_weak_words": "Deep Learning for weak words",
        "deep_learning_weak_words_note": "Open the words below and complete pronunciation plus AI sentence usage.",
    ...
    "zh-Hant": {
        ...
        "start_recommended_practice": "開始建議練習",
        "secondary_actions": "其他選項",
        "learning_primary_review": "先重練錯題",
        "learning_primary_next": "開始下一組 10 個詞",
        "deep_learning_weak_words": "深度學習薄弱詞",
        "deep_learning_weak_words_note": "打開下面的詞彙，完成發音和 AI 句子應用。",
...
TRANSLATIONS["zh-Hans"].update(
    {
        ...
        "start_recommended_practice": "开始建议练习",
        "secondary_actions": "其他选项",
        "learning_primary_review": "先重练错题",
        "learning_primary_next": "开始下一组 10 个词",
        "deep_learning_weak_words": "深度学习薄弱词",
        "deep_learning_weak_words_note": "打开下面的词汇，完成发音和 AI 句子应用。",
