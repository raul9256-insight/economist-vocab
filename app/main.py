...
TRANSLATIONS = {
    "en": {
        ...
        "landing_registered_title": "Knowledge Passport",
        "landing_registered_lede": "Knowledge Passport: when you leave school and move into professional life, you can export your knowledge graph into your personal account.",
    ...
    "zh-Hant": {
        ...
        "landing_registered_title": "知識護照（Knowledge Passport）",
        "landing_registered_lede": "當離開學校進入職場時，你可以將其知識圖譜導出到個人賬號。",
        "signup_title": "建立帳號",
...
TRANSLATIONS["zh-Hans"].update(
    {
        ...
        "landing_registered_title": "知识护照（Knowledge Passport）",
        "landing_registered_lede": "当离开学校进入职场时，你可以将其知识图谱导出到个人账号。",
        "signup_title": "创建账号",
